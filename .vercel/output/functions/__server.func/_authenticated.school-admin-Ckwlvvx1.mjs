...
import { B as Building2, L as LogOut, j as LayoutDashboard, s as UserPlus, p as UserCog, U as Users, G as GraduationCap, h as Gift, o as CircleQuestionMark } from "./_libs/lucide-react.mjs";
...
function SchoolAdminLayout() {
  ...
  if (!user || !["school_admin", "admin", "super_admin"].includes(user.role)) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "School Admin access only." })
    ] }) });
  }
  const navItems = [{
    ...
    to: "/school-admin/branches",
    label: "Branches",
    icon: Building2
  }, {
    to: "/school-admin/assign-branch-admin",
    label: "Assign",
    icon: UserPlus
  }, {
    to: "/school-admin/branch-admins",
    label: "Admins",
    icon: UserCog
  }, {
    ...
    to: "/school-admin/rewards",
    label: "Rewards",
    icon: Gift
  }, {
    to: "/school-admin/help",
    label: "Help",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 border-b bg-card/80 backdrop-blur-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-14 max-w-lg items-center justify-between px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground", children: "School Admin" })
      ] }),
...
export {
  SchoolAdminLayout as component
};
