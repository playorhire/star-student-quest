...
function SchoolAdminStudents() {
  ...
  async function loadData() {
    setLoading(true);
    setError(null);
    const [sRes, cRes] = await Promise.all([supabase.from("students").select("id, user_id, name, email, roll_number, total_points, classes(name), avatar_emoji, class_id, section, branches(name)").eq("school_id", user.schoolId).order("name"), supabase.from("classes").select("id, name, branches(name)").eq("school_id", user.schoolId).order("name")]);
    if (sRes.error) {
  ...
  async function handleSubmit(e) {
    ...
    if (editing) {
      ...
      } = await supabase.from("students").select("id").eq("roll_number", form.roll_number.trim()).eq("school_id", user.schoolId).maybeSingle();
      if (existingStudent) {
        toast.error("A student with this roll number already exists in your school");
        setSubmitting(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "All students in your school" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!credStudent, onOpenChange: (open) => !open && setCredStudent(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium font-mono text-sm", children: credStudent?.email || "—" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleResetPassword, disabled: resettingPassword || !credStudent?.email, className: "w-full", variant: "outline", children: [
...
export {
  SchoolAdminStudents as component
};
