...
import { z as Plus, X, a7 as LoaderCircle, ac as MapPin, K as KeyRound, F as Pencil, T as Trash2, v as BookOpen } from "./_libs/lucide-react.mjs";
...
function SchoolAdminTeachers() {
  ...
  const [credTeacher, setCredTeacher] = reactExports.useState(null);
  ...
  async function loadData() {
    setLoading(true);
    setError(null);
    const [tRes, bRes, cRes, sRes] = await Promise.all([supabase.from("teachers").select("id, user_id, name, email, avatar_emoji, branch_id, branches(name), teacher_assignments(id, class_id, subject_id, section, classes(name), subjects(name))").eq("school_id", user.schoolId).order("name"), supabase.from("branches").select("id, name").eq("school_id", user.schoolId).order("name"), supabase.from("classes").select("id, name, branches(name)").eq("school_id", user.schoolId).order("name"), supabase.from("subjects").select("id, name, class_id").eq("school_id", user.schoolId).order("name")]);
    if (tRes.error) {
  ...
  async function handleSubmit(e) {
    ...
    if (editing) {
      ...
      } = await supabase.from("teachers").select("id").eq("email", form.email.trim()).eq("school_id", user.schoolId).maybeSingle();
      if (existingTeacher) {
      ...
      if (form.password) {
        ...
        const {
          data: updatedTeacher
        } = await supabase.from("teachers").select("user_id").eq("id", newTeacher.id).single();
  ...
  async function handleResetPassword() {
    ...
    const {
      error: error2
    } = await supabase.auth.resetPasswordForEmail(credTeacher.email, {
      redirectTo: `${window.location.origin}/login`
    });
    if (error2) {
      toast.error(`Reset failed: ${error2.message}`);
    } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-black", children: "Teachers" }),
    ...
    showForm && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: form.branch_id, onChange: (e) => setForm((f) => ({
            ...f,
            branch_id: e.target.value
          })), className: "w-full h-10 rounded-md border border-input bg-background px-3 py-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Select Branch (optional)" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            ...
            t.branch_id && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-xs text-muted-foreground mt-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3" }),
              t.branches?.name || "Branch"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", onClick: () => setCredTeacher(t), title: "Manage credentials", children: /* @__PURE__ */ jsxRuntimeExports.jsx(KeyRound, { className: "h-4 w-4" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!credTeacher, onOpenChange: (open) => !open && setCredTeacher(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Teacher Credentials" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: credTeacher?.name })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Email" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium font-mono text-sm", children: credTeacher?.email || "—" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Auth User ID" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xs bg-muted rounded px-2 py-1 break-all", children: credTeacher?.user_id || "No auth account linked" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleResetPassword, disabled: resettingPassword || !credTeacher?.email, className: "w-full", variant: "outline", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-1.5 text-center", children: "Requires email service configured in Supabase. If disabled, reset password via Supabase Dashboard → Authentication → Users." })
        ] })
      ] })
    ] }) }),
...
export {
  SchoolAdminTeachers as component
};
