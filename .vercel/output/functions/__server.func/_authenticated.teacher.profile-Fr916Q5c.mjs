...
import { u as useAuth, s as supabase, C as Card, b as CardHeader, c as CardTitle, a as CardContent, I as Input, B as Button } from "./_ssr/router-DuskeiVN.mjs";
import { g as getPasswordValidation, P as PasswordRequirements } from "./_ssr/password-requirements-DAEBrgK4.mjs";
import { L as Label } from "./_ssr/label-TEKU4-jV.mjs";
import "./_libs/sonner.mjs";
import "./_libs/html5-qrcode.mjs";
import "./_libs/canvas-confetti.mjs";
import { m as User, O as Mail, K as KeyRound, R as CircleCheckBig } from "./_libs/lucide-react.mjs";
...
import "./_ssr/progress-BdcwYQ-W.mjs";
...
function TeacherProfile() {
  ...
  async function load() {
    ...
    const {
      data
    } = await supabase.from("teachers").select("*").eq("user_id", user.id).maybeSingle();
    if (data) {
      setName(data.name);
      setEmail(data.email);
    } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Update your name, email, and password" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-primary/20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: name, onChange: (e) => setName(e.target.value), className: "rounded-xl" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "email", value: email, onChange: (e) => setEmail(e.target.value), className: "rounded-xl" })
        ] }),
