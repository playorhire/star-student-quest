...
function BranchAdminStudents() {
  ...
  async function loadData() {
    ...
    const [sRes, cRes] = await Promise.all([
      (supabase as any).from("students").select("id, name, roll_number, total_points, classes(name), avatar_emoji, class_id, section").eq("branch_id", user!.branchId).order("name"),
