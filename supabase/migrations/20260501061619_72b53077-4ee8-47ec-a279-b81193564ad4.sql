REVOKE EXECUTE ON FUNCTION public.search_student_for_parent(text, text) FROM PUBLIC, anon;
REVOKE EXECUTE ON FUNCTION public.get_my_linked_children() FROM PUBLIC, anon;
